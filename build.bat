...
cl /nologo /O2 /MT /EHsc /W4 /DUNICODE /utf-8 src\main.cpp /I third_party\pdfium\include /Fo:build\ ^
  /link third_party\pdfium\lib\pdfium.dll.lib /OUT:build\mnpdf.exe
